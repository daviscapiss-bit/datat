...
function CheckQuest() 
    MyLevel = game:GetService("Players").LocalPlayer.dati.Level.Value
    if World1 then
...
local locallv = W:AddLabel("Level")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                locallv:Set("Level :".." "..game:GetService("Players").LocalPlayer.dati.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localrace:Set("Race :".." "..game:GetService("Players").LocalPlayer.dati.Race.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localbeli:Set("Beli :".." "..game:GetService("Players").LocalPlayer.dati.Beli.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localfrag:Set("Fragments :".." "..game:GetService("Players").LocalPlayer.dati.Fragments.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localexp:Set("ExP Points :".." "..game:GetService("Players").LocalPlayer.dati.Exp.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                localstat:Set("Stats Points :".." "..game:GetService("Players").LocalPlayer.dati.Points.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value) or game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value) then
                    localDevil:Set("Devil Fruit :".." "..game:GetService("Players").LocalPlayer.dati.DevilFruit.Value)
                else
...
Fruit = S:AddLabel("Fruit")
  ...
  local Pointstat = S:AddLabel("Stat Points")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Pointstat:Set("Stat Points : "..tostring(game:GetService("Players")["LocalPlayer"].dati.Points.Value))
            end)
        end
    end)
...
local Fruit = S:AddLabel("Fruit : ")
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Melee:Set("Melee : "..game.Players.localPlayer.dati.Stats.Melee.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Defense:Set("Defense : "..game.Players.localPlayer.dati.Stats.Defense.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Sword:Set("Sword : "..game.Players.localPlayer.dati.Stats.Sword.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Gun:Set("Gun : "..game.Players.localPlayer.dati.Stats.Gun.Level.Value)
            end)
        end
    end)
    ...
    spawn(function()
        while wait() do
            pcall(function()
                Fruit:Set("Fruit : "..game.Players.localPlayer.dati.Stats["Demon Fruit"].Level.Value)
            end)
        end
    end)
        ...
        SV:AddButton({
            ...
            Callback = function()
                ...
                function serversearch()
                    for _, v in pairs(game:GetService("HttpService"):JSONDecode(game:HttpGetAsync(gamelink)).dati) do
...
R:AddButton({
  ...
  wait(.1)
  Game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame = CFrame.new(28286.35546875, 14895.3017578125, 102.62469482421875)
                if game:GetService("Players").LocalPlayer.dati.Race.Value == "Fishman" then
                wait(1)
                topos(CFrame.new(28224.056640625, 14889.4267578125, -210.5872039794922))
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Human" then
                wait(1)
                topos(CFrame.new(29237.294921875, 14889.4267578125, -206.94955444335938))
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Cyborg" then
                wait(1)
                topos(CFrame.new(28492.4140625, 14894.4267578125, -422.1100158691406))
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Skypiea" then
                wait(1)
                topos(CFrame.new(28967.408203125, 14918.0751953125, 234.31198120117188))
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Ghoul" then
                wait(1)
                topos(CFrame.new(28672.720703125, 14889.1279296875, 454.5961608886719))
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Mink" then
                wait(1)
...
LockLevelValue = 2450
OldLevel = game.Players.localPlayer.dati.Level.Value
C:AddSlider({
	Name = "Level To Lock",
	Min = 1,
	Max = 2550,
...
spawn(function()
    while wait(.1) do
        if LockLevel then
            if game.Players.localPlayer.dati.Level.Value >= LockLevelValue then
                                    ...
                                    if string.find(game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text, NameMon) then
                                        ...
                                        repeat task.wait()
                                            if v.Humanoid.Health <= HealthMs then
                                                AutoHaki()
                                                EquipWeapon(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value)
    ...
    while wait() do
        if UseSkill then
            pcall(function()
                CheckQuest()
                for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                    if game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value) then
                        MasBF = game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.dati.DevilFruit.Value].Level.Value
                    elseif game:GetService("Players").LocalPlayer.Backpack:FindFirstChild(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value) then
                        MasBF = game:GetService("Players").LocalPlayer.Backpack[game:GetService("Players").LocalPlayer.dati.DevilFruit.Value].Level.Value
                    end
                    ...
                    elseif game:GetService("Players").LocalPlayer.Character:FindFirstChild(game:GetService("Players").LocalPlayer.dati.DevilFruit.Value) then
                        if _G.SkillZ then 
                            local args = {
                                [1] = PosMonMasteryFruit.Position
                            }
    ...
    pcall(function()
        game:GetService("RunService").RenderStepped:Connect(function()
            if UseSkill then
                ...
                game:GetService("Players").LocalPlayer.Character[game:GetService("Players").LocalPlayer.dati.DevilFruit.Value].RemoteEvent:FireServer(unpack(args))
            end
        end)
    end)
end)
    ...
    pcall(function()
        while wait() do 
            if _G.AutoSuperhuman then
                if game.Players.LocalPlayer.Backpack:FindFirstChild("Combat") or game.Players.LocalPlayer.Character:FindFirstChild("Combat") and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 150000 then
                ...
                if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") or game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") or game.Players.LocalPlayer.Character:FindFirstChild("Electro") or game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") or game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") or game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") then
                    ...
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Backpack:FindFirstChild("Black Leg").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 300000 then
                        UnEquipWeapon("Black Leg")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
                    end
                    if game.Players.LocalPlayer.Character:FindFirstChild("Black Leg") and game.Players.LocalPlayer.Character:FindFirstChild("Black Leg").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 300000 then
                        UnEquipWeapon("Black Leg")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyElectro")
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Electro") and game.Players.LocalPlayer.Backpack:FindFirstChild("Electro").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 750000 then
                        UnEquipWeapon("Electro")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
                    end
                    if game.Players.LocalPlayer.Character:FindFirstChild("Electro") and game.Players.LocalPlayer.Character:FindFirstChild("Electro").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 750000 then
                        UnEquipWeapon("Electro")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuyFishmanKarate")
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 300 and game:GetService("Players")["Localplayer"].dati.Fragments.Value >= 1500 then
                        UnEquipWeapon("Fishman Karate")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2") 
                    end
                    if game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 300 and game:GetService("Players")["Localplayer"].dati.Fragments.Value >= 1500 then
                        UnEquipWeapon("Fishman Karate")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","1")
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BlackbeardReward","DragonClaw","2") 
                    end
                    if game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw") and game.Players.LocalPlayer.Backpack:FindFirstChild("Dragon Claw").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 3000000 then
                        UnEquipWeapon("Dragon Claw")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
                    end
                    if game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw") and game.Players.LocalPlayer.Character:FindFirstChild("Dragon Claw").Level.Value >= 300 and game:GetService("Players")["LocalPlayer"].dati.Beli.Value >= 3000000 then
                        UnEquipWeapon("Dragon Claw")
                        wait(.1)
                        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BuySuperhuman")
                    end 
...
spawn(function()
    while wait() do
        if _G.AutoSecondSea then
            pcall(function()
                if game.Players.LocalPlayer.dati.Level.Value >= 700 and World1 then
                    _G.AutoFarm = false
    ...
    pcall(function()
        while wait() do
            if _G.Farmfast and World1 then
                if game.Players.LocalPlayer.dati.Level.Value >= 10 then
...
spawn(function()
    pcall(function()
        while wait() do
            if _G.Farmfast and World1 then
                if game.Players.LocalPlayer.dati.Level.Value >= 50 then
    ...
    spawn(function()
        ...
        spawn(function()
            ...
            spawn(function()
                ...
                spawn(function()
                    while wait() do
                        if game.Players.localPlayer.dati.Points.Value >= PointStats then
                            if melee then
                                local args = {
                                    [1] = "AddPoint",
                                    [2] = "Melee",
...
local MyFragment = game.Players.LocalPlayer.dati.Fragments.Value
local Mybeli = game.Players.LocalPlayer.dati.Beli.Value
spawn(function()
    while wait() do
...
spawn(function()
    while task.wait() do
        pcall(function()
            if _G.Auto_Saber and game.Players.LocalPlayer.dati.Level.Value >= 200 and not Check_Sword("Saber") and World1 then
                ToggleFarm:Set(false)
                _G.Auto_Saber = true
            end
        end)
    ...
    pcall(function()
        while wait() do
            if _G.AutoBartilo then
                if game.Players.LocalPlayer.dati.Level.Value >= 800 then
                    _G.AutoBartilo = true
                    ToggleFarm:Set(false)
                end
            end
...
spawn(function()
    pcall(function()
        while wait(.1) do
            if _G.AutoBartilo then
                if game:GetService("Players").LocalPlayer.dati.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 0 then
                ...
                elseif game:GetService("Players").LocalPlayer.dati.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 1 then
                ...
                elseif game:GetService("Players").LocalPlayer.dati.Level.Value >= 800 and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("BartiloQuestProgress","Bartilo") == 2 then
    ...
    spawn(function()
        while wait() do
            if _G.AutoThirdSea then
                pcall(function()
                    if game:GetService("Players").LocalPlayer.dati.Level.Value >= 1500 and World2 then
                        _G.AutoFarm = false
    ...
    pcall(function()
        while wait() do
            if _G.AutoQuestRace then
             if game:GetService("Players")["LocalPlayer"].PlayerGui.Main.Timer.Visible == true then
                if game:GetService("Players").LocalPlayer.dati.Race.Value == "Human" then
                    for i,v in pairs(game.Workspace.Enemies:GetDescendants()) do
                        if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                            pcall(function()
                                repeat wait(.1)
                ...
                elseif game:GetService("Players").LocalPlayer.dati.Race.Value == "Fishman" then
...
spawn(function()
    while wait() do
        for i,v in pairs(game.Players.LocalPlayer:GetChildren()) do
            if v.Name == "datiLoaded" or v.Name == "datiPreloaded" then
                v:Destroy()
            end
        end
    end
...
-- AutoMiner + Server Hop para The Wild West

-- CONFIGURAÇÕES
local cavernaPos = Vector3.new(-1124, 90, -1452) -- Coordenadas da entrada da mina
local venderPos = Vector3.new(-279, 28, -372) -- Coordenadas do vendedor
local minerios = {"Gold", "Silver", "Copper", "Coal"} -- Minérios a coletar
local serverHopDelay = 30 -- segundos entre as trocas de servidor
...
function minerar()
    for _, rock in pairs(workspace:GetDescendants()) do
        if rock:IsA("Model") and table.find(minerios, rock.Name) then
            repeat
                equipPickaxe()
                game:GetService("ReplicatedStorage").Remotes.MineRock:FireServer(rock)
                wait(1.2)
            until not rock or not rock.Parent
        end
    end
end

-- FUNÇÃO: vender minérios
function vender()
    teleport(venderPos)
    wait(2)
    for _, item in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
        if table.find(minerios, item.Name) then
            game:GetService("ReplicatedStorage").Remotes.SellOre:FireServer(item)
        end
    end
end

-- FUNÇÃO: trocar de servidor
function trocarServidor()
    ...
    wait(2)
    game:GetService("TeleportService"):TeleportToPlaceInstance(game.PlaceId, teleportId)
end
